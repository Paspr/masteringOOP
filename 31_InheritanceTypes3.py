# пример наследования реализации (implementation inheritance)
# из предыдущей части - множество наследуется от хэш-таблицы и расширяет ее специфичными операциями (09_PowerSet.py)
...
# пример льготного наследования (facility inheritance)
...
class getColorCode(RGBColor):
    def get_code_red(self):
        return self.RED

    def get_code_green(self):
        return self.GREEN
    
    def get_code_blue(self):
        return self.BLUE


testObj = getColorCode()
print(testObj.get_code_green()) # 2
